...
//     let correctAnswer;
//     let validDivision = false; // Move the declaration here
...
//                     // Ensure there is no remainder and secondNumber is not 1
//                     validDivision = true;
...
//     const wrongAnswers = Array.from({ length: 3 }, () => getRandomNumber(correctAnswer - deviation, correctAnswer + deviation));
...
function generateNewNumbers() {
    ...
    // Generate unique wrong answer options
